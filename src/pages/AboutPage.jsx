...
export default function AboutPage() {
  ...
  return (
    <div>
      ...
      <section className="section"><div className="wrap" ref={r2}>
        <div style={s.mvGrid} className="fi-group">
          <div className="card-tile fi" style={s.mvCard}>
      ...
      <section className="section"><div className="wrap" ref={r3}><div className="panel fi-group">
      ...
      <section className="section section-page-end"><div className="wrap" ref={r4}><div className="panel fi-group">
...
const s = {
  ...
  h2:{ fontFamily:"'Plus Jakarta Sans','Segoe UI',system-ui,sans-serif", fontSize:22, fontWeight:600, color:'#111111' },
  panelH2:{ fontFamily:"'Plus Jakarta Sans','Segoe UI',system-ui,sans-serif", fontSize:20, fontWeight:600, color:'#111111', marginBottom:24 },
  ...
  mvCard:{ display:'flex', flexDirection:'column', minHeight:'100%' },
  ...
  valueLabel:{ fontFamily:"'Roboto','Segoe UI',system-ui,sans-serif", fontSize:12, fontWeight:500, color:'#111111', padding:'4px 14px', border:'1px solid #FF8210', borderRadius:100, display:'inline-flex', alignItems:'center', height:28, whiteSpace:'nowrap', transition:'box-shadow 150ms ease' },
  valueDesc:{ fontFamily:"'Roboto','Segoe UI',system-ui,sans-serif", fontSize:13, color:'#979899', lineHeight:1.65, paddingTop:6 },
  refBlock:{ marginTop:24, padding:16, background:'#FFFFFF', border:'0.5px solid #E4E5E5', borderRadius:12, display:'flex', flexDirection:'column', gap:6, boxShadow:'0 1px 4px rgba(15,76,92,0.06)' },
  refText:{ fontFamily:"'Roboto','Segoe UI',system-ui,sans-serif", fontSize:11, color:'#979899', lineHeight:1.5 },
};
