...
export default function HowItWorksPage() {
  ...
  return (
    <div>
      ...
      <section className="section section-page-end"><div className="wrap" ref={r3}>
...
const s = {
  ...
  h3:{ fontFamily:"'Plus Jakarta Sans','Segoe UI',system-ui,sans-serif", fontSize:17, fontWeight:600, color:'#111111' },
  body:{ fontFamily:"'Roboto','Segoe UI',system-ui,sans-serif", fontSize:14, color:'#979899', lineHeight:1.72 },
  stepRow:{ display:'flex', flexWrap:'wrap', gap:10, marginTop:24, justifyContent:'flex-start', alignItems:'center' },
  step:{ display:'flex', alignItems:'center', padding:'10px 16px', border:'1px solid #FF8210', borderRadius:12, background:'#F9FAFA', flex:'1 1 auto', maxWidth:200 },
  stepLabel:{ fontFamily:"'Roboto','Segoe UI',system-ui,sans-serif", fontSize:13, color:'#111111', whiteSpace:'pre-line', lineHeight:1.35, display:'block', textAlign:'left' },
  journeyWrap:{ display:'flex', flexDirection:'column', gap:24 },
  journeyBlock:{ background:'#FFFFFF', border:'0.5px solid #E4E5E5', borderRadius:16, overflow:'hidden', boxShadow:'0 2px 12px rgba(15,76,92,0.08)' },
  journeyMeta:{ padding:'28px 32px 24px' },
  ...
  placeholderLabel:{ fontFamily:"'Roboto','Segoe UI',system-ui,sans-serif", fontSize:12, color:'#979899', textAlign:'center' },
};
