  ...
  const item = (label, path) => (
    <button
      ...
      style={{
        ...
        background: location.pathname === path ? '#f5f5f3' : 'transparent',
        border: 'none', textAlign: 'left', fontSize: '0.875rem',
        color: '#1a1a18', cursor: 'pointer', fontFamily: 'inherit',
        borderRadius: '8px', fontWeight: location.pathname === path ? '600' : '400',
      }}>
      {label}
    </button>
  );
  ...
  return (
    <div ref={ref} style={{ position: 'relative' }}>
      <button
        ...
        <span style={{ display: 'block', width: '18px', height: '2px', background: '#1a1a18', borderRadius: '2px' }} />
        <span style={{ display: 'block', width: '18px', height: '2px', background: '#1a1a18', borderRadius: '2px' }} />
        <span style={{ display: 'block', width: '18px', height: '2px', background: '#1a1a18', borderRadius: '2px' }} />
      </button>
      {open && (
        <div style={{
          ...
          border: '1px solid #eeede8', minWidth: '180px', padding: '6px', zIndex: 200,
        }}>
          {item('Configurator', '/')}
          ...
          <button onClick={handleLogout} style={{ display: 'block', width: '100%', padding: '0.625rem 1rem', background: 'transparent', border: 'none', textAlign: 'left', fontSize: '0.875rem', color: '#e74c3c', cursor: 'pointer', fontFamily: 'inherit', borderRadius: '8px' }}>
            Sign out
          </button>
        </div>
      )}
