...
const s = StyleSheet.create({
  page: { fontFamily: 'Helvetica', fontSize: 9, color: '#1a1a18', paddingTop: 36, paddingBottom: 52, paddingHorizontal: 40, backgroundColor: '#fff' },
  header: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 18, paddingBottom: 14, borderBottomWidth: 1.5, borderBottomColor: '#1a1a18', borderBottomStyle: 'solid' },
  logoImg: { width: 110, height: 48, objectFit: 'contain' },
  brandText: { fontSize: 16, fontFamily: 'Helvetica-Bold', color: '#1a1a18', marginBottom: 2 },
  brandSub: { fontSize: 7.5, color: '#888888' },
  brandUrl: { fontSize: 7.5, color: '#185fa5' },
  rightCol: { alignItems: 'flex-end' },
  refLabel: { fontSize: 7, color: '#999999', textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 2 },
  refNum: { fontSize: 11, fontFamily: 'Helvetica-Bold', color: '#1a1a18' },
  dateText: { fontSize: 7.5, color: '#555555', marginTop: 3 },
  ...
  infoValue: { fontSize: 8.5, color: '#1a1a18' },
  infoValueSub: { fontSize: 7.5, color: '#555555', marginTop: 1 },
  dividerInfo: { borderTopWidth: 0.5, borderTopColor: '#e5e5e3', borderTopStyle: 'solid', marginBottom: 14 },
  section: { marginBottom: 12 },
  sectionTitle: { fontSize: 7.5, fontFamily: 'Helvetica-Bold', color: '#1a1a18', textTransform: 'uppercase', letterSpacing: 0.6, marginBottom: 6, paddingBottom: 4, borderBottomWidth: 0.5, borderBottomColor: '#e5e5e3', borderBottomStyle: 'solid' },
  row: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 3, borderBottomWidth: 0.5, borderBottomColor: '#f0f0ee', borderBottomStyle: 'solid' },
  ...
  rowMeta: { fontSize: 8, color: '#aaaaaa', textAlign: 'right', minWidth: 36, marginRight: 8 },
  divLine: { borderTopWidth: 1, borderTopColor: '#1a1a18', borderTopStyle: 'solid', marginVertical: 5 },
  totalRow: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 5, paddingHorizontal: 8, backgroundColor: '#f9f9f7', borderRadius: 3, marginTop: 4 },
  ...
  grandTotal: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 10, paddingHorizontal: 12, backgroundColor: '#1a1a18', borderRadius: 5, marginBottom: 12 },
  ...
  disclaimer: { marginTop: 12, paddingTop: 10, borderTopWidth: 0.5, borderTopColor: '#e5e5e3', borderTopStyle: 'solid' },
  ...
  disclaimerText: { fontSize: 6.5, color: '#aaaaaa', lineHeight: 1.5 },
        ...
        <View style={s.header} wrap={false}>
          <View>
            {userDetails?.logo_url
              ...
              : <Image src="/logo.jpg" style={{ width: 120, height: 52, objectFit: 'contain' }} />
            }
          </View>
